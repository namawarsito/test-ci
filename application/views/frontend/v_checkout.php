												...
												for($a = 0; $a < $jumlah_isi_keranjang; $a++){
													...
													<tr>
														...
														<td class="text-center">
															<?php if( $i->produk_diskonharga > 0 ){ ?>
																<?php echo "Rp. ".number_format(($i->produk_harga - $i->produk_diskonharga)).",-"; ?> 
																<span class="price-before" style="font-size: 12px"> <?php echo "Rp. ".number_format($i->produk_harga).",-"; ?> </span>
															<?php }else{ ?>
